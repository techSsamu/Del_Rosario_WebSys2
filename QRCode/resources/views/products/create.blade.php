...
<div class="container mx-auto px-4 py-8">
    ...
    <form action="{{ route('products.store') }}" method="POST" class="bg-white rounded-lg shadow-md p-6 max-w-md">
        @csrf
        ...
        <div class="mb-6">
            ...
            <input type="number" id="price" name="price" step="0.01" value="{{ old('price') }}" class="w-full border border-gray-300 rounded px-3 py-2" required>
        </div>
